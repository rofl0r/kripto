...
OBJ="version.o mac.o hmac.o salsa20.o mode.o blake256.o blake512.o blake2s.o blake2b.o keccak1600.o keccak800.o threefish256.o threefish512.o threefish1024.o ctr.o rc4.o chacha.o rijndael.o rc6.o twofish.o anubis.o seed.o noekeon.o hash.o sha2_256.o sha2_512.o memwipe.o random.o pkcs7.o block.o stream.o"
