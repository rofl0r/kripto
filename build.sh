...
SRC="lib/version.c lib/mac.c lib/mac/hmac.c lib/stream/salsa20.c lib/mode.c lib/hash/blake256.c lib/hash/blake512.c lib/hash/blake2s.c lib/hash/blake2b.c lib/hash/keccak1600.c lib/hash/keccak800.c lib/block/threefish256.c lib/block/threefish512.c lib/block/threefish1024.c lib/mode/ctr.c lib/mode/cbc.c lib/stream/rc4.c lib/stream/chacha.c lib/block/rijndael.c lib/block/rc6.c lib/block/twofish.c lib/block/anubis.c lib/block/seed.c lib/block/noekeon.c lib/hash.c lib/hash/sha2_256.c lib/hash/sha2_512.c lib/memwipe.c lib/random.c lib/pkcs7.c lib/block.c lib/stream.c lib/pbkdf2.c"
OBJ="version.o mac.o hmac.o salsa20.o mode.o blake256.o blake512.o blake2s.o blake2b.o keccak1600.o keccak800.o threefish256.o threefish512.o threefish1024.o ctr.o cbc.o rc4.o chacha.o rijndael.o rc6.o twofish.o anubis.o seed.o noekeon.o hash.o sha2_256.o sha2_512.o memwipe.o random.o pkcs7.o block.o stream.o pbkdf2.o"
